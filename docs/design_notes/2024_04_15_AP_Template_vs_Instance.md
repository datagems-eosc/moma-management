...
- Stores the evaluation dimensions of that execution (ecological, data quality, human relevance...)
...
Let's now do a complete example. The purpose of this example AP is to take in a natural language query and execute it as an SQL statement.
